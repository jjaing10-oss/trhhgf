...
function rptStyle(){
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  body{font-family:'Noto Sans KR',sans-serif;background:#fff;color:#0f172a;padding:0;font-size:12px;line-height:1.65}
  ...
  .insight{background:rgba(15,23,42,.65);border-left:4px solid #3b82f6;padding:11px 14px;margin:10px 0;border-radius:0 8px 8px 0;font-size:11.5px}
  .warn{background:rgba(15,23,42,.65);border-left:4px solid #dc2626;padding:11px 14px;margin:10px 0;border-radius:0 8px 8px 0;font-size:11.5px}
  .action{background:rgba(15,23,42,.65);border-left:4px solid #16a34a;padding:11px 14px;margin:10px 0;border-radius:0 8px 8px 0;font-size:11.5px}
  .caution{background:rgba(15,23,42,.65);border-left:4px solid #d97706;padding:11px 14px;margin:10px 0;border-radius:0 8px 8px 0;font-size:11.5px}
  ...
  .stat-card-green{background:rgba(15,23,42,.65);border:1px solid #bbf7d0}.stat-card-green::before{background:#059669}
  .stat-card-gray{background:#f8fafc;border:1px solid #e2e8f0}.stat-card-gray::before{background:#94a3b8}
  .stat-card-best{background:rgba(15,23,42,.65);border:1px solid #86efac}.stat-card-best::before{background:#16a34a}
...
function loadSubscriberData(){
  ...
  subscriberData = saved && saved.months && saved.wireless ? saved : cloneObj(DEFAULT_SUBSCRIBER_DATA);
}
...
function buildSubscriberAggregate(d){
  ...
  const y24 = Number((((d||{}).wireless||{}).series||{}).total?.[0]||0);
...
function initSubscriberUI(){
  ...
  const capaCalc=totalNew+totalChg;
